...
class PlayerFrame:
    ...
    def _build_overview_new(self):
        ...
        self.superframe.createSuperFrameText(text="MATCHES:", x=x+265, y=y-38, anchor="c", font=fonttk("Refrigerator Deluxe Bold", 11, "bold", italic=False), fill="#aebdf4")
        
        self.superframe.createSuperFrameText(text=str(round(p.matches_played,1)), x=x+316, y=y-38, anchor="w", font=fonttk("Refrigerator Deluxe ExtraBold", 11, "bold", italic=False), fill="#aebdf4")
        
        # OV Stat Values
        
        
        
        self.superframe.createSuperFrameText(text=p.win_pct, x=x, y=y, anchor="c", font=fonttk("Refrigerator Deluxe Bold", 18, "bold", italic=False), fill="#121225")
        
        self.superframe.createSuperFrameText(text=str(round(p.kd_ratio,2)), x=x+98, y=y, anchor="c", font=fonttk("Refrigerator Deluxe Bold", 18, "bold", italic=False), fill="#121225")
        
        self.superframe.createSuperFrameText(text=p.mvp_pct, x=x+202, y=y, anchor="c", font=fonttk("Refrigerator Deluxe Bold", 18, "bold", italic=False), fill="#121225")
        
        self.superframe.createSuperFrameText(text=str(round(p.kda_ratio,2)), x=x+301, y=y, anchor="c", font=fonttk("Refrigerator Deluxe Bold", 18, "bold", italic=False), fill="#121225")
        
        # Ov Stat Labels
        
        self.superframe.createSuperFrameText(text="WIN RATE", x=x, y=y+set, anchor="c", font=fonttk("Refrigerator Deluxe Bold", 8, "bold", italic=False), fill="#121225")
        
        self.superframe.createSuperFrameText(text="KD RATIO", x=x+98, y=y + set, anchor="c", font=fonttk("Refrigerator Deluxe Bold", 8, "bold", italic=False), fill="#121225")
        
        self.superframe.createSuperFrameText(text="MVP RATE", x=x+202, y=y + set, anchor="c", font=fonttk("Refrigerator Deluxe Bold", 8, "bold", italic=False), fill="#121225")
        
        self.superframe.createSuperFrameText(text="KDA RATIO", x=x+301, y=y + set, anchor="c", font=fonttk("Refrigerator Deluxe Bold", 8, "bold", italic=False), fill="#121225")
    ...
    def _build_heroes_new(self):
        ...
        for hero in heroes:
            ...
            self.superframe.createSuperFrameText(text="WIN%", x=x, y=y, anchor="c", font=fonttk("Refrigerator Deluxe Bold", 10, "bold", italic=False), fill="#121225")
            
            self.superframe.createSuperFrameText(text="KD", x=x+65, y=y, anchor="c", font=fonttk("Refrigerator Deluxe Bold", 10, "bold", italic=False), fill="#121225")
            
            self.superframe.createSuperFrameText(text="MVP%", x=x+133, y=y, anchor="c", font=fonttk("Refrigerator Deluxe Bold", 10, "bold", italic=False), fill="#121225")
            
            self.superframe.createSuperFrameText(text="GAMES", x=x+198, y=y, anchor="c", font=fonttk("Refrigerator Deluxe Bold", 10, "bold", italic=False), fill="#121225")
            
            # Stat Values
            set = 61
            self.superframe.createSuperFrameText(text=hero.Stats.win_pct, x=x, y=y+set, anchor="c", font=fonttk("Refrigerator Deluxe Bold", 14, "bold", italic=False), fill="#121225")
            
            self.superframe.createSuperFrameText(text=str(round(hero.Stats.kd_ratio,2)), x=x+65, y=y+set, anchor="c", font=fonttk("Refrigerator Deluxe Bold", 14, "bold", italic=False), fill="#121225")
            
            self.superframe.createSuperFrameText(text=hero.Stats.mvp_pct, x=x+133, y=y+set, anchor="c", font=fonttk("Refrigerator Deluxe Bold", 14, "bold", italic=False), fill="#121225")
            
            self.superframe.createSuperFrameText(text=str(round(hero.Stats.matches_played,1)), x=x+198, y=y+set, anchor="c", font=fonttk("Refrigerator Deluxe Bold", 14, "bold", italic=False), fill="#121225")
