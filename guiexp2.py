...
class PlayerFrame(tk.Canvas):
    ...
    def _build_outer(self):
        ...
        # self.outer.createSuperFrameImage(img_key=f"__NewBg ({bnum})",anc="nw",size = (374, 880), x =0, y=0 )
        
        
        #self.overview_bar.createSuperFrameImage(img_key="glow2", anc="nw",size=(375, 375), x=0,y=-115,clip=True)
    ...
    def _build_name_bar(self):
        ...
        self.name_bar = SuperFrame(self.outer, bg="#2b2b2b",height=80,width=self.outer.winfo_reqwidth())
    ...
    def _build_overview(self):
        ...
        self.overview_stats.createSuperFrameImage(img_key="glow2", anc="nw",size=(375, 375), x=0,y=-115,clip=True)
