...
def create_player_frame(root, player, image_map):
    ...
    name_label = tk.Label(top_bar, text=player.name,bg="#2b2e41", fg="white",font=("Arial", 17, "bold"), anchor="w")
    ...
    la= tk.Label(right_frame_top, text=f"KD: {player.kd1}",fg=kd1,bg="#1c1b2d", font=("Arial", 13,"bold"))
    la.pack(pady=5)
   # tk.Label(right_frame, text="Placeholder 1", font=("Arial", 4)).pack(pady=5)
    ...
    lb = tk.Label(right_frame_bot, text=f"KD: {player.kd2}",fg=kd2,bg="#1c1b2d", font=("Arial", 13,"bold"))
    lb.pack(pady=5)
