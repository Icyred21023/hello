...
def try_selenium(u):
    ...
    while True:
        try:
            ...
            Chrome.driver.get("https://rivalsdata.com/")
    ...
    while True:
        try:
            ...
            if entry is None:
                ...
                cf, cookie = extract_cookie_values(entry)

            import curl
            URL = "https://api.rivalsdata.com/player"
            pl= {"uid": config.USER_UID}
            response = curl.curl_get(URL,cf,pl)
        ...
        try:
            ...
            time.sleep(1.5)
             ...
             if '403' in str(e):
                ...
                return False
                bSelenium, match = try_selenium(u)
